				...
				<div className='left__side'>
					<div className='left__side'>
						<div className='left__side__content'>
							<p>
								Un essaim d'abeilles vous pose un problème et vous avez besoin d'aide pour les retirer ?
							</p>
							<p>
								<strong>Guêpes et frelons 87</strong>&nbsp;se charge de traiter les essaims avec soins
								et contribue ainsi à leur sauvegarde.
							</p>
							<p>
								Les abeilles ne sont pas des insectes nuisibles, elles n’attaquent que si elles se
								sentent menacées.
							</p>
							<p>
								Néanmoins pour les faire éloigner sans problèmes, il faut faire appel à des
								spécialistes.
							</p>
							<p>
								Notre équipe commence par analyser la situation. En effet, le traitement des ruches
								diffère de celui des essaims et pour chaque opération il faut le matériel et les
								techniques adéquats.
							</p>
							<p>
								Le but est de récupérer la reine et une grande partie des abeilles ouvrières. Une fois
								les <strong>abeilles récupérées</strong>, nous les plaçons dans nos propres ruches.
							</p>
							<p>

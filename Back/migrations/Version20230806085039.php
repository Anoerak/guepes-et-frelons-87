 ...
 */
final class Version20230806085039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_informations (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, zip INT NOT NULL, city VARCHAR(255) NOT NULL, phone_number INT NOT NULL, mobile_number VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_EF5A188BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');

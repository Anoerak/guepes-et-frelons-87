...
return [
    ...
    [ // $dynamicRoutes
        ...
        201 => [[['_route' => '_api_/user_informations/{id}{._format}_get', '_controller' => 'api_platform.action.placeholder', '_format' => null, '_stateless' => null, '_api_resource_class' => 'App\\Entity\\UserInformations', '_api_operation_name' => '_api_/user_informations/{id}{._format}_get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        227 => [

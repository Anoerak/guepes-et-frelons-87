...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerSNNN45y\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerSNNN45y/EntityManagerGhostEbeb667.php';
require __DIR__.'/ContainerSNNN45y/RequestPayloadValueResolverGhost3590451.php';
require __DIR__.'/ContainerSNNN45y/getValidator_WhenService.php';
require __DIR__.'/ContainerSNNN45y/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerSNNN45y/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerSNNN45y/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerSNNN45y/getValidator_ExpressionService.php';
require __DIR__.'/ContainerSNNN45y/getValidator_EmailService.php';
require __DIR__.'/ContainerSNNN45y/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerSNNN45y/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerSNNN45y/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerSNNN45y/getTwigService.php';
require __DIR__.'/ContainerSNNN45y/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerSNNN45y/getSession_FactoryService.php';
require __DIR__.'/ContainerSNNN45y/getServicesResetterService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerSNNN45y/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerSNNN45y/getSecrets_VaultService.php';
require __DIR__.'/ContainerSNNN45y/getRouting_LoaderService.php';
require __DIR__.'/ContainerSNNN45y/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerSNNN45y/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerSNNN45y/getErrorControllerService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerSNNN45y/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerSNNN45y/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerSNNN45y/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerSNNN45y/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerSNNN45y/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerSNNN45y/getContainer_GetenvService.php';
require __DIR__.'/ContainerSNNN45y/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerSNNN45y/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerSNNN45y/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerSNNN45y/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerSNNN45y/getCache_SystemClearerService.php';
require __DIR__.'/ContainerSNNN45y/getCache_SystemService.php';
require __DIR__.'/ContainerSNNN45y/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerSNNN45y/getCache_AppClearerService.php';
require __DIR__.'/ContainerSNNN45y/getCache_AppService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_JsonSchema_TypeFactoryService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Hydra_JsonSchema_SchemaFactoryService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerSNNN45y/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerSNNN45y/getTemplateControllerService.php';
require __DIR__.'/ContainerSNNN45y/getRedirectControllerService.php';
require __DIR__.'/ContainerSNNN45y/getUserRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getUserInformationsRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getUserDeliveryInformationsRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getStockRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getProductRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getJsonDataRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getBillRepositoryService.php';
require __DIR__.'/ContainerSNNN45y/getFrontEndDatasControllerService.php';
require __DIR__.'/ContainerSNNN45y/get_ServiceLocator_Y4Zrx_Service.php';
require __DIR__.'/ContainerSNNN45y/get_ServiceLocator_HBdvAhpService.php';
require __DIR__.'/ContainerSNNN45y/get_Security_RequestMatcher_KLbKLHaService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerSNNN45y/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\FrontEndDatasController';
$classes[] = 'App\Repository\BillRepository';
$classes[] = 'App\Repository\JsonDataRepository';
$classes[] = 'App\Repository\ProductRepository';
$classes[] = 'App\Repository\StockRepository';
$classes[] = 'App\Repository\UserDeliveryInformationsRepository';
$classes[] = 'App\Repository\UserInformationsRepository';
